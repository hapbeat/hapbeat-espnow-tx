...
// set_opus_complexity (mode 9 SOLID48 tuning, DEC-046 follow-up) /
// set_stream_hp_buffer (mode 9 SOLID48 receiver jitter buffer, AUDIO_SOURCE
// only — DEC-046 follow-up) / set_stream_mode / set_relay_source / reboot.
// ---------------------------------------------------------------------------
